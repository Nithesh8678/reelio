...
export function Contact() {
    return (<section id="contact" className="py-32 bg-reelio-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-24">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-bold tracking-[0.2em] uppercase text-primary hover:text-white transition-colors">
                    Go to WhatsApp
                  </a>
                </div>
              </div>
          ...
          <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-reelio-dark p-12 border border-white/5">
