        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {offeringsContent.map((offering, index) => (
            <motion.button
              ...
              className="group relative overflow-hidden border border-white/10 bg-white/[0.02] text-left transition-colors duration-500 hover:border-white/30"
            >
              <div
                className="pointer-events-none absolute -inset-16 opacity-0 blur-3xl transition-opacity duration-700 group-hover:opacity-100"
                style={{ backgroundColor: `${offering.accent}40` }}
              />
        ...
        {selectedOffering ? (
          <>
            <motion.button
              ...
              className="fixed inset-0 z-[90] bg-black/78 backdrop-blur-[2px]"
            />
                ...
                <div className="grid max-h-[92vh] overflow-y-auto lg:grid-cols-2">
                  <motion.div
                    ...
                    transition={
                      shouldReduceMotion
                        ? { duration: 0.15 }
                        : { duration: 0.44, delay: 0.03, ease: modalEase }
                    }
                  ...
                  <motion.div
                    ...
                    transition={
                      shouldReduceMotion
                        ? { duration: 0.15 }
                        : { duration: 0.44, delay: 0.08, ease: modalEase }
                    }
