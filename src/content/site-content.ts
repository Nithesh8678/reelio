...
export const aboutCopy = {
  ...
  fullCycle:
    "Our engagement models are built around your momentum. Whether you need a high-impact 1-week production sprint to launch a campaign or a multi-year strategic partnership to scale your digital legacy, we adapt our cycle to match your growth velocity.",
  origin:
