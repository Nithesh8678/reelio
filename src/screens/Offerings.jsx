      ...
      <div className="bg-reelio-black">
        ...
        <section className="relative overflow-hidden py-28 md:py-32">
          <div className="pointer-events-none absolute inset-0" style={{
            backgroundImage: "radial-gradient(circle at 20% 0%, rgba(227,30,36,0.22), transparent 42%), radial-gradient(circle at 80% 80%, rgba(34,211,238,0.16), transparent 46%)",
        }}/>
          ...
          <div className="container relative mx-auto px-6">
            ...
            <div className="relative mx-auto max-w-5xl">
              ...
              <div className="grid gap-8 md:gap-10">
                {steps.map((item, i) => {
            const isRight = i % 2 === 1;
            return (<motion.div key={item.step} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-80px" }} transition={{ duration: 0.45, delay: i * 0.08 }} className={`relative md:flex ${isRight ? "md:justify-end" : ""}`}>
